...
export const COLLECTIONS: Record<CollectionSlug, CollectionData> = {
  ...
  "balik-pulau": {
    ...
    title: "Balik Pulau",
    tagline: "Official Shabab Super Cup merchandise — durian, paddy fields, and Pekan Kongsi, stitched into one drop.",
...
export const PRODUCTS: ProductData[] = [
  ...
  },
  {
    ...
    blurb: "Durian orchards, paddy fields, Pekan Kongsi's shopfronts, and the road sign into town — collaged into one crest. Kampung energy, tournament heart.",
    price: 99,
  ...
  },
  {
    slug: "lights-out",
    name: "Lights Out",
    blurb: "Corridor lights off at eleven, common room lights never off. If you know, you know.",
    price: 85,
    collection: "hostel",
